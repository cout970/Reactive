...
fun RBuilder.selectBox(key: String? = null, block: ComponentBuilder<SelectBox>.() -> Unit = {}) = +ComponentBuilder(SelectBox()).apply(block).also {

    postMount {
        val selectBox = it.component
        val mouseClickEventListener = object : SelectBoxClickListener(selectBox) {
